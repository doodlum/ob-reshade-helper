...
// OBSE array datatype, represented by std::map<ArrayKey, ArrayElement>
...
namespace PluginAPI
{
	...
	public:
		...
		static OBSEArrayVarInterface::Array* CreateStringMap(const char** keys, const OBSEArrayVarInterface::Element* values, UInt32 size, Script* callingScript);
		static OBSEArrayVarInterface::Array* CreateMap(const double* keys, const OBSEArrayVarInterface::Element* values, UInt32 size, Script* callingScript);

		static bool AssignArrayCommandResult(OBSEArrayVarInterface::Array* arr, double* dest);
		static void SetElement(OBSEArrayVarInterface::Array* arr, const OBSEArrayVarInterface::Element& key, const OBSEArrayVarInterface::Element& value);
		static void AppendElement(OBSEArrayVarInterface::Array* arr, const OBSEArrayVarInterface::Element& value);

		static UInt32 GetArraySize(OBSEArrayVarInterface::Array* arr);
		static OBSEArrayVarInterface::Array* LookupArrayByID(UInt32 id);
		static bool GetElement(OBSEArrayVarInterface::Array* arr, const OBSEArrayVarInterface::Element& key,
			OBSEArrayVarInterface::Element& out);
		static bool GetElements(OBSEArrayVarInterface::Array* arr, OBSEArrayVarInterface::Element* elements,
